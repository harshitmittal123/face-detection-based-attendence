...
#display time when code is executed
...
#save password and id during registeration of student
...
#create options for creating image and save profile for registration
...
#take image while taking name and id and save in excel sheet in csv format
...
#store image in folder name traning image and store password in traning image label
...
#assign files in folder that contain empty face,id
...
#check person is known or not while taking image and store attendence in csv file
...
#intialize months using date and time module
...
#assign menubar buttons which dispay on menu
...
#create buttons in output such as clear, take image,save profile
